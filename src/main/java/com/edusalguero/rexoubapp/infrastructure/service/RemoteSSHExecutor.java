...
import com.edusalguero.rexoubapp.domain.service.executor.ExecutionException;
...
public class RemoteSSHExecutor implements RemoteExecutor {
    ...
    @Autowired
    public RemoteSSHExecutor(@Value("${rexoubapp.privateKeyPath}") String privateKeyPath, @Value("${rexoubapp.passphrase}") String passphrase) throws JSchException {
